          ...
          <div className="h-64 w-[343px] md:w-xl md:h-[480px] ">
            <div className="md:p-15 md:flex md:flex-col md:h-[500px] p-3 md:justify-evenly">
              ...
              <div className=" flex gap-1 flex-wrap">
                <button className="h-6  w-[79px]  bg-pink-300 rounded-2xl ">
                  React
                </button>
                <button className="h-6 w-[85px]  bg-pink-300 rounded-2xl ">
                  Next.js
                </button>
                <button className="h-6  w-28  bg-pink-300 rounded-2xl ">
                  Typescript
                </button>
                <button className="h-6  w-[87px]  bg-pink-300 rounded-2xl ">
                  Nest.js
                </button>
                <button className="h-6  w-[120px]  bg-pink-300 rounded-2xl ">
                  PostreSQL
                </button>
                <button className="h-6  w-[130px]  bg-pink-300 rounded-2xl ">
                  Tailwindcss
                </button>
                <button className="h-6  w-[81px]  bg-pink-300 rounded-2xl ">
                  Figma
                </button>
                <button className="h-6  w-24  bg-pink-300 rounded-2xl ">
                  Cypress
                </button>
                <button className="h-6  w-[110px]  bg-pink-300 rounded-2xl ">
                  Storybook
                </button>
                <button className="h-6  w-[60px]  bg-pink-300 rounded-2xl ">
                  Git
                </button>
              </div>
